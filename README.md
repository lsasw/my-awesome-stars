...
- [clawbench-dev/clawbench](https://github.com/clawbench-dev/clawbench) - Mobile-first AI workstation — full integration of mainstream AI agents on phone & tablet. Single binary, zero dependencies, one-click deploy.
